    ...
    <tbody>
        ...
        while ($item = mysqli_fetch_assoc($inventory_result)) {
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-info" onclick='openEditModal(<?php echo json_encode($item); ?>)'>Editar</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editInventoryItem" method="POST" action="ajax.php">
                    ...
                    <div class="form-group">
                        <label>Tipo de Artículo</label>
                        <select class="form-control" name="item_type" id="edit_item_type" required>
                            <option value="apero">Aperitivo</option>
                            <option value="bebida">Bebida</option>
                        </select>
                    </div>
